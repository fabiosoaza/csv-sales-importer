...
import com.github.fabiosoaza.salesimporter.infrastructure.routes.aggregationstrategy.GroupedBodyAndErrorPropertyStrategyAggregation;
...
import com.github.fabiosoaza.salesimporter.infrastructure.validator.RecordsValidatorProcessor;
...
public class SalesImportRoutes extends RouteBuilder{
	...
	private RecordsValidatorProcessor recordsValidatorProcessor;
	private TransformerProcessor transformerProcessor; 
	private IsValidRecordPredicate isValidRecordPredicate;
		
	@Autowired
	public SalesImportRoutes(RecordsValidatorProcessor recordsValidatorProcessor, TransformerProcessor transformerProcessor, ImportRecordValidator importRecordValidator, IsValidRecordPredicate isValidRecordPredicate) {
		super();
		this.recordsValidatorProcessor = recordsValidatorProcessor;
